          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-soft mb-6">
              ...
              <span className="text-sm font-medium text-neutral-600">
                Open 7 Days a Week - Quality Dental Care
              </span>
            </div>
            ...
            <p className="text-lg md:text-xl text-neutral-600 mb-8 max-w-lg">
              Om Chabahil Dental Hospital - Providing quality dental care with modern technology 
              and experienced professionals in Kathmandu, Nepal.
            </p>
