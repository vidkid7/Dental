...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  *:focus-visible {
  ...
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(11 165 236 / var(--tw-ring-opacity, 1));
...
.btn-primary:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(2 106 162 / var(--tw-bg-opacity, 1));
...
.\!input:focus {
  --tw-border-opacity: 1;
  border-color: rgb(11 165 236 / var(--tw-border-opacity, 1));
  --tw-ring-offset-shadow: var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);
...
.gradient-text {
  ...
  --tw-gradient-from: #0086c9 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(0 134 201 / 0) var(--tw-gradient-to-position);
...
.border-primary-300 {
  --tw-border-opacity: 1;
  border-color: rgb(124 212 253 / var(--tw-border-opacity, 1));
}
.border-primary-500 {
  --tw-border-opacity: 1;
  border-color: rgb(11 165 236 / var(--tw-border-opacity, 1));
...
.bg-primary-200 {
  --tw-bg-opacity: 1;
  background-color: rgb(185 230 254 / var(--tw-bg-opacity, 1));
}
.bg-primary-50 {
  --tw-bg-opacity: 1;
  background-color: rgb(240 249 255 / var(--tw-bg-opacity, 1));
...
.bg-primary-900 {
  --tw-bg-opacity: 1;
  background-color: rgb(11 74 111 / var(--tw-bg-opacity, 1));
}
.bg-purple-100 {
  --tw-bg-opacity: 1;
...
.bg-\[url\(\'\/patterns\/dental-pattern\.svg\'\)\] {
  background-image: url('/patterns/dental-pattern.svg');
}
.bg-gradient-to-br {
...
.from-primary-200 {
  --tw-gradient-from: #b9e6fe var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(185 230 254 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-400 {
  --tw-gradient-from: #36bffa var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(54 191 250 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-50 {
...
.from-primary-500 {
  --tw-gradient-from: #0ba5ec var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 165 236 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-600 {
  --tw-gradient-from: #0086c9 var(--tw-gradient-from-position);
...
.from-primary-900 {
  --tw-gradient-from: #0b4a6f var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 74 111 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-900\/30 {
  --tw-gradient-from: rgb(11 74 111 / 0.3) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 74 111 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.via-primary-800 {
  --tw-gradient-to: rgb(6 89 134 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #065986 var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-transparent {
...
.to-primary-700 {
  --tw-gradient-to: #026aa2 var(--tw-gradient-to-position);
}
.to-primary-800 {
  --tw-gradient-to: #065986 var(--tw-gradient-to-position);
}
.to-transparent {
...
.text-primary-200 {
  --tw-text-opacity: 1;
  color: rgb(185 230 254 / var(--tw-text-opacity, 1));
}
.text-primary-300 {
  --tw-text-opacity: 1;
  color: rgb(124 212 253 / var(--tw-text-opacity, 1));
}
.text-primary-400 {
  --tw-text-opacity: 1;
  color: rgb(54 191 250 / var(--tw-text-opacity, 1));
}
.text-primary-400\/50 {
  color: rgb(54 191 250 / 0.5);
}
.text-primary-500 {
  --tw-text-opacity: 1;
...
.text-primary-900 {
  --tw-text-opacity: 1;
  color: rgb(11 74 111 / var(--tw-text-opacity, 1));
}
.text-purple-700 {
  --tw-text-opacity: 1;
...
.shadow-card {
  --tw-shadow: 0 0 0 1px rgba(0, 0, 0, 0.05), 0 4px 16px rgba(0, 0, 0, 0.1);
  --tw-shadow-colored: 0 0 0 1px var(--tw-shadow-color), 0 4px 16px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-elevated {
...
.blog-content ol > :not([hidden]) ~ :not([hidden]) {
  --tw-space-y-reverse: 0;
  margin-top: calc(0.5rem * calc(1 - var(--tw-space-y-reverse)));
  margin-bottom: calc(0.5rem * var(--tw-space-y-reverse));
}
...
.hover\:border-primary-400:hover {
  --tw-border-opacity: 1;
  border-color: rgb(54 191 250 / var(--tw-border-opacity, 1));
}
