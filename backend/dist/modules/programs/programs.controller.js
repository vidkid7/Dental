...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new academic program' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'type', required: false, enum: program_entity_1.ProgramType }),
...
__decorate([
    ...
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get a program by slug' }),
